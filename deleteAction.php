<?php
    ...
    $conn=mysqli_connect("212.1.212.1","bigcattl_test","s6951435","bigcattl_formal");
	...
	$result_Course_Taught=mysqli_query($conn,$sql_Course_Taught_Num);
	...
	$result_Academic_Services=mysqli_query($conn,$sql_Academic_Services_Num);
	...
	$result_Peer_reviewed_Journals=mysqli_query($conn,$sql_Peer_reviewed_Journals_Num);
...
;
	...
	$result_sql_Research_Monographs=mysqli_query($conn,$sql_Research_Monographs_Num);
	...
	$result_sql_Meeting_Proceedings_And_Other=mysqli_query($conn,$sql_Meeting_Proceedings_And_Other_Num);
	...
	$result_Professional_Meeting_Proceedings=mysqli_query($conn,$sql_Professional_Meeting_Proceedings_Num);
	...
	$result_Textbooks_Chapters=mysqli_query($conn,$sql_Textbooks_Chapters_Num);
	...
	$result_Cases=mysqli_query($conn,$sql_Cases_Num);
	...
	$result_Other_Teaching_Materials=mysqli_query($conn,$sql_Other_Teaching_Materials_Num);
	...
	$result_Honors_Competitive_Awards_Received=mysqli_query($conn,$sql_Honors_Competitive_Awards_Received_Num);
	...
	$result_Professional_History=mysqli_query($conn,$sql_Professional_History_Num);
	...
	$result_Professional_Development=mysqli_query($conn,$sql_Professional_Development_Num);
	...
	$result_Professional_Societies=mysqli_query($conn,$sql_Professional_Societies_Num);
