...
--
ALTER TABLE `Academic_Services`
  MODIFY `Id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1252;
...
--
ALTER TABLE `Meeting_Proceedings_And_Other`
  MODIFY `Id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=98989940;

--
-- 使用資料表 AUTO_INCREMENT `Peer_reviewed_Journals`
--
ALTER TABLE `Peer_reviewed_Journals`
  MODIFY `Id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1255545;

--
-- 使用資料表 AUTO_INCREMENT `Professional_History`
--
ALTER TABLE `Professional_History`
  MODIFY `Id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7267;

--
-- 使用資料表 AUTO_INCREMENT `Professional_Societies`
--
ALTER TABLE `Professional_Societies`
  MODIFY `Id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=888265;
...
--
ALTER TABLE `Research_Monographs`
  MODIFY `Id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=995543;
